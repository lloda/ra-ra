...
// $CXX -o small.s -S -O3 -DRA_CHECK_BOUNDS=0 -std=c++14 -Wall -Werror -Wno-unknown-pragmas -Wno-parentheses -Wno-error=strict-overflow -march=native -I/home/danielo/Prog/ek-git/src/ext/ra -Iexamples small.C -funroll-loops -ffast-math -fno-exceptions
