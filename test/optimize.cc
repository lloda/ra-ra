...
// [ra4] Map holds iterators which hold pointers so auto y = Vec {1, 2, 3, 4} + Vec {5, 6, 7, 8} would hold pointers to lost temps. Cf ra::iter(iter). So this example only works bc it's optimized.
